...
def pytest_runtest_makereport(item, call):
    ...
    if call.when == "call" and "default_user_page" in item.funcargs:  # store test results for each phase of a call
        request = item.funcargs['request']                            # which can be "setup", "call", "teardown"
